...
function Surface(props) {
  ...
  return /* @__PURE__ */ React__default.createElement("svg", _extends$q({}, filterProps(others, true, "svg"), {
...
var Layer = /* @__PURE__ */ React__default.forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ React__default.createElement("g", _extends$p({
    className: layerClass
...
var Symbols = function Symbols2(_ref) {
  ...
  if (cx === +cx && cy === +cy && size === +size) {
    return /* @__PURE__ */ React__default.createElement("path", _extends$o({}, filteredProps, {
  ...
  return _createClass$h(DefaultLegendContent2, [{
    ...
    value: function renderItems() {
      ...
      return payload.map(function(entry, i) {
        ...
        return /* @__PURE__ */ React__default.createElement("li", _extends$n({
          className,
          style: itemStyle,
...
var Text = function Text2(_ref5) {
  ...
  return /* @__PURE__ */ React__default.createElement("text", _extends$l({}, filterProps(textProps, true), {
    x,
    y,
    ...
    value: function render() {
      ...
      var errorBars = data.map(function(entry) {
        ...
        return /* @__PURE__ */ React__default.createElement(Layer, _extends$k({
          ...
          return /* @__PURE__ */ React__default.createElement("line", _extends$k({}, coordinates, {
...
var renderRadialLabel = function renderRadialLabel2(labelProps, label, attrs) {
  ...
  return /* @__PURE__ */ React__default.createElement("text", _extends$j({}, attrs, {
...
function Label(_ref4) {
  ...
  return /* @__PURE__ */ React__default.createElement(Text, _extends$j({
...
function LabelList(_ref) {
  ...
  return /* @__PURE__ */ React__default.createElement(Layer, {
    ...
    return /* @__PURE__ */ React__default.createElement(Label, _extends$i({}, filterProps(entry, true), others, idProps, {
...
function parseLabelList(label, data) {
  ...
  if (isObject(label)) {
    return /* @__PURE__ */ React__default.createElement(LabelList, _extends$i({
      data
    }, label, {
      key: "labelList-implicit"
    }));
...
var Rectangle = function Rectangle2(rectangleProps) {
  ...
  return /* @__PURE__ */ React__default.createElement(Animate, {
    ...
    }, /* @__PURE__ */ React__default.createElement("path", _extends$f({}, filterProps(props, true), {
      className: layerClass,
...
var Trapezoid = function Trapezoid2(props) {
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ React__default.createElement("g", null, /* @__PURE__ */ React__default.createElement("path", _extends$c({}, filterProps(trapezoidProps, true), {
      className: layerClass,
  ...
  return /* @__PURE__ */ React__default.createElement(Animate, {
    ...
    return /* @__PURE__ */ React__default.createElement(Animate, {
      ...
      duration: animationDuration,
      easing: animationEasing
    }, /* @__PURE__ */ React__default.createElement("path", _extends$c({}, filterProps(trapezoidProps, true), {
      className: layerClass,
...
var Brush = /* @__PURE__ */ (function(_PureComponent) {
  ...
  return _createClass$b(Brush2, [{
    ...
    value: function renderText() {
      ...
      }, /* @__PURE__ */ React__default.createElement(Text, _extends$b({
        textAnchor: "end",
        verticalAnchor: "middle",
        x: Math.min(startX, endX) - offset,
        y: y + height / 2
      }, attrs), this.getTextOfTick(startIndex)), /* @__PURE__ */ React__default.createElement(Text, _extends$b({
        textAnchor: "start",
        verticalAnchor: "middle",
...
function BarRectangle(props) {
  return /* @__PURE__ */ React__default.createElement(Shape, _extends$a({
    shapeType: "rectangle",
  ...
  return _createClass$a(Bar2, [{
    ...
    value: function renderRectanglesStatically(data) {
      ...
      return data && data.map(function(entry, i) {
        ...
        return /* @__PURE__ */ React__default.createElement(Layer, _extends$9({
    ...
    value: function renderBackground() {
      ...
      return data.map(function(entry, i) {
        ...
        return /* @__PURE__ */ React__default.createElement(BarRectangle, _extends$9({
...
_defineProperty$a(ReferenceDot, "renderDot", function(option, props) {
  ...
  if (/* @__PURE__ */ React__default.isValidElement(option)) {
    ...
    dot = /* @__PURE__ */ React__default.createElement(Dot, _extends$7({}, props, {
      cx: props.cx,
      cy: props.cy,
...
var CartesianAxis = /* @__PURE__ */ (function(_Component) {
  ...
  return _createClass$5(CartesianAxis2, [{
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ React__default.isValidElement(option)) {
        tickItem = /* @__PURE__ */ React__default.cloneElement(option, _objectSpread$4(_objectSpread$4({}, props), {}, {
...
function renderLineItem(option, props) {
  ...
  if (/* @__PURE__ */ React__default.isValidElement(option)) {
    ...
    lineItem = /* @__PURE__ */ React__default.createElement("line", _extends$4({}, restOfFilteredProps, {
      x1,
      y1,
      x2,
      y2,
...
function CartesianGrid(props) {
  ...
  }), /* @__PURE__ */ React__default.createElement(HorizontalGridLines, _extends$4({}, propsIncludingDefaults, {
    offset,
    horizontalPoints,
    xAxis,
    yAxis
  })), /* @__PURE__ */ React__default.createElement(VerticalGridLines, _extends$4({}, propsIncludingDefaults, {
    offset,
    verticalPoints,
    xAxis,
    yAxis
  })), /* @__PURE__ */ React__default.createElement(HorizontalStripes, _extends$4({}, propsIncludingDefaults, {
    horizontalPoints
  })), /* @__PURE__ */ React__default.createElement(VerticalStripes, _extends$4({}, propsIncludingDefaults, {
    verticalPoints
  })));
}
...
var Line = /* @__PURE__ */ (function(_PureComponent) {
  ...
  return _createClass$4(Line2, [{
    ...
    value: function renderCurveStatically(points, needClip, clipPathId, props) {
      ...
      return /* @__PURE__ */ React__default.createElement(Curve, _extends$3({}, curveProps, {
    ...
    value: function renderDotItem(option, props) {
      ...
      if (/* @__PURE__ */ React__default.isValidElement(option)) {
        ...
        dotItem = /* @__PURE__ */ React__default.createElement(Dot, _extends$3({
          key
        }, dotProps, {
          className
        }));
